...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/games/{id}/team/invite/accept": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/games/{id}/team/invite/reject": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
